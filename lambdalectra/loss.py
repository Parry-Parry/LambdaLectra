...
class LambdaRankLoss:
    ...
    def get_pairwise_diffs_for_vector(self, x):
        ...
        a, b = torch.meshgrid(x[:self.ndcg_at], x)
        return b - a
    ...
    def setup(self):
        ...
        self.dcg_position_discounts = 1. / torch.log2((torch.arange(0, self.pred_truncate_at) + 2).type(self.dtype))
        ...
        self.batch_indices = tile(unsqueeze(torch.arange(0, self.batch_size), 1), [1, self.pred_truncate_at]).view(self.pred_truncate_at * self.batch_size, 1)
